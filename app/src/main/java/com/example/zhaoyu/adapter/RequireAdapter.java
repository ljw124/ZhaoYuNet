 ...
 */
public class RequireAdapter extends RecyclerView.Adapter<RequireAdapter.MyViewHolder> {

    private Context context;
    protected LayoutInflater inflater;
    private List<String> data;
    private List<Boolean> isClicks;
    public RequireAdapter(Context context){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View item = inflater.inflate(R.layout.item_require, viewGroup, false);
