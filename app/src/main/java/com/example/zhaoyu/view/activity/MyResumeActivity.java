...
import com.example.zhaoyu.databinding.ActivityMyResumeBinding;
import com.example.zhaoyu.viewmodel.MyVM;

public class MyResumeActivity extends BaseActivity {

    ActivityMyResumeBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_my_resume, null);
