...
import com.hyphenate.easeui.widget.presenter.EaseCustomChatViewPresenter;
...
public class EaseMessageAdapter extends BaseAdapter{
	...
	public int getViewTypeCount() {
	    if(customRowProvider != null && customRowProvider.getCustomChatRowTypeCount() > 0){
	        return customRowProvider.getCustomChatRowTypeCount() + 16; // TODO: 2019/6/5
	    }
        return 16; // TODO: 2019/6/5
    }
	...
	public int getItemViewType(int position) {
		...
		if(customRowProvider != null && customRowProvider.getCustomChatRowType(message) > 0){
		    return customRowProvider.getCustomChatRowType(message) + 15; // TODO: 2019/6/5
		}
		...
		if (message.getType() == EMMessage.Type.TXT) {
		    if(message.getBooleanAttribute(EaseConstant.MESSAGE_ATTR_IS_BIG_EXPRESSION, false)){
				...
				// TODO: 2019/6/5
		    } else if (message.getBooleanAttribute(EaseConstant.MESSAGE_CUSTOM_CHAT_VIEW, false)){
		    	return message.direct() == EMMessage.Direct.RECEIVE ? MESSAGE_TYPE_RECV_CUSTOM : MESSAGE_TYPE_SENT_CUSTOM;
			}
	...
	protected EaseChatRowPresenter createChatRowPresenter(EMMessage message, int position) {
        ...
        case TXT:
            if(message.getBooleanAttribute(EaseConstant.MESSAGE_ATTR_IS_BIG_EXPRESSION, false)){
				...
				presenter = new EaseCustomChatViewPresenter();
			}  else{
